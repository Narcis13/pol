                ...
                {{state.solicitare.denumire}}
                    ...
                    <q-tab-panels v-model="tab" animated>
                        ...
                        <q-tab-panel name="lista">
                          <div v-show="cabineteIncarcate&&state.cabinete.length==0">
                            ...
                            <div v-if="cabineteIncarcate&&state.cabinete.length>0" class="row justify-center q-gutter-xl">
...
export default defineComponent({
  ...
  setup(){
    ...
    let tab=ref('lista')
    let cabineteIncarcate=ref(false)
    let numeclinica=ref('')
